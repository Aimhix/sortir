...
/**
 * Classe FixturesReloadCommand permet de lancer un script de commande de façon automatique.
...
//        $options = array('command' => 'make:migration');
//        try {
...
//        }
//
//        $options = array('command' => 'doctrine:migration:migrate');
//        try {
//            $application->run(new \Symfony\Component\Console\Input\ArrayInput($options));
//        } catch (\Exception $e) {
//            $output->writeln([
